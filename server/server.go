...
import (
	...
	"github.com/dexidp/dex/connector/tenxcrd"
...
func newServer(ctx context.Context, c Config, rotationStrategy rotationStrategy) (*Server, error) {
	...
	handleFunc("/oidc/auth", s.handleCallBack)
	handleFunc("/oidc/{connector}/logout", s.logout)
...
var ConnectorsConfig = map[string]func() ConnectorConfig{
	...
	"tenxcrd":         func() ConnectorConfig { return new(tenxcrd.Config) },
